...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Place Category</h2>
        </template>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div>
                                ...
                                <TextInput id="name" type="text" class="mt-1 block w-full" v-model="form.name" required
                                    autofocus placeholder="e.g. Residential, Industrial" />
                            ...
                            <div class="mt-4">
                                ...
                                <div
                                    ...
                                    <div v-if="chemicals.length === 0" class="text-sm text-gray-500">
                                        ...
                                        <Link :href="route('chemicals.create')" class="text-indigo-600 underline">Add
                                            Chemicals
                                            first</Link>.
                                    </div>
                            ...
                            <div class="flex items-center justify-end mt-6">
                                <Link :href="route('place-categories.index')"
